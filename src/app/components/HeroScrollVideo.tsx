  ...
  return (
    <div className="relative flex min-h-[25rem] items-center justify-center sm:min-h-[32rem] lg:min-h-[37rem] lg:justify-end">
      <video
        ...
        preload="metadata"
        tabIndex={-1}
        className={`hero-media pointer-events-none relative z-0 h-[30.5rem] w-full max-w-[19rem] -translate-y-3 select-none object-contain object-center sm:h-[40rem] sm:max-w-[24.25rem] sm:-translate-y-4 lg:h-[45rem] lg:max-w-[26.75rem] lg:-translate-y-5 ${className}`}
      >
