...
const { verifyAdminPassword, issueAdminCookie, verifyAdminCookie, requireAdmin } = require('../../../server/admin-auth');
const { getSettings, saveSettings, defaultSettings } = require('../../../server/settings-store');
const { invalidatePaymentsConfigCache } = require('../../../server/payments-config-store');
const {
    buildPaymentsConfig,
...
const { requestTransactionById: requestGhostspayStatus } = require('../../../server/ghostspay-provider');
const { requestTransactionById: requestSunizeStatus } = require('../../../server/sunize-provider');
const { requestTransactionById: requestParadiseStatus } = require('../../../server/paradise-provider');
const {
    getAtivusStatus,
    isAtivusPaidStatus,
...
} = require('../../../server/ghostspay-status');
const {
    getSunizeStatus,
    getSunizeUpdatedAt,
    getSunizeAmount,
...
} = require('../../../server/paradise-status');
...
const FUNNEL_OVERVIEW_STAGES = [
    {
        ...
        source: 'page',
        page: 'home',
        description: 'Entrada na landing da campanha'
    },
    {
        key: 'promo',
        label: 'Mines iniciado',
        shortLabel: 'Mines',
        source: 'page',
        page: 'promo',
        description: 'Inicio da rodada promocional'
    },
    {
        key: 'dados',
        label: 'Dados',
        ...
        source: 'page',
        page: 'dados',
        description: 'Formulario de resgate'
    },
    {
        key: 'nike',
        label: 'Pagina Nike',
...
async function pushcutTest(req, res) {
    ...
    const basePayload = {
        ...
        customerEmail: 'lead.teste@nikebrasil.app',
        cep: '08717630',
        source: 'Meta Ads',
        utm_source: 'meta',
