const { sanitizeDigits, extractIp } = require('../../../server/ativus');
const { upsertLead, getLeadBySessionId } = require('../../../server/lead-store');
...
const { normalizeGatewayId } = require('../../../server/payment-gateway-config');
const { getPaymentsConfig } = require('../../../server/payments-config-store');
const {
...
} = require('../../../server/ativushub-provider');
const {
...
} = require('../../../server/ghostspay-provider');
const {
    requestCreateTransaction: requestSunizeCreate,
    requestTransactionById: requestSunizeStatus
} = require('../../../server/sunize-provider');
const { getSunizeStatus } = require('../../../server/sunize-status');
const {
...
} = require('../../../server/paradise-provider');
const { getParadiseStatus } = require('../../../server/paradise-status');
