...
function initAdmin() {
    ...
    const funnelPageMeta = {
        home: { label: '/', desc: 'Landing principal da campanha' },
        promo: { label: '#promo', desc: 'Secao do Mines iniciada pelo lead' },
        dados: { label: '/dados', desc: 'Formulario de resgate preenchido' },
        nike: { label: '/nike', desc: 'Pagina final da oferta' },
        pix: { label: 'pix', desc: 'Pagamento via PIX quando ativado' }
    };
    ...
    const loadPageCounts = async () => {
        ...
        if (pagesInsights) {
            const order = ['home', 'promo', 'dados', 'nike', 'pix'];
